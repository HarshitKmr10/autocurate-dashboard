...
Always respond with valid JSON in the exact format requested."""
    ...
    async def select_kpis(self, domain: str, profile_summary: Dict[str, Any]) -> Dict[str, Any]:
        """
...
"""
    ...
    async def select_charts(self, domain: str, profile_summary: Dict[str, Any], kpis: List[Dict]) -> Dict[str, Any]:
        """
...
"""
    ...
    async def parse_natural_language_query(self, query: str, available_columns: List[str], domain: str) -> Dict[str, Any]:
        """
...
"""
    ...
    async def _make_llm_request(
        ...
        for attempt in range(self.max_retries):
            try:
                logger.debug(f"Making LLM request (attempt {attempt + 1})")
                ...
                if attempt < self.max_retries - 1:
                    ...
                    raise LLMException("Rate limit exceeded, max retries reached")
                ...
                if attempt < self.max_retries - 1:
                    ...
                    raise LLMException("API timeout, max retries reached")
                ...
                if attempt < self.max_retries - 1:
                    ...
                    raise LLMException(f"LLM request failed: {str(e)}")
